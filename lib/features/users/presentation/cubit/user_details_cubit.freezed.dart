...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( UserEntity user)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( UserEntity user)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Loading():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( UserEntity user)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
return loaded(_that.user);case _Error() when error != null:
...
class _Loading implements UserDetailsState {
  const _Loading();
...
class _Loaded implements UserDetailsState {
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $UserDetailsStateCopyWith<$Res> {
...
class _Error implements UserDetailsState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $UserDetailsStateCopyWith<$Res> {
